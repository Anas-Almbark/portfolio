...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        ...
        <form method="POST" action="{{route("project.store")}}" class="forms-sample" enctype="multipart/form-data">
            @csrf
            ...
            <input type="text" class="form-control" name="url_demo" id="url_demo" placeholder="Url demo">
            </div>
            <div class="form-group">
            <label for="url_repo">Url Repo</label>
            <input type="text" class="form-control" name="url_repo" id="url_repo" placeholder="Url repo">
            </div>
            <div class="form-group">
